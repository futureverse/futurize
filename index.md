...
| **[rmgarch](https://cran.r-project.org/package=rmgarch)** | `dccfit()`, `dccfilter()`, `dccforecast()`, `dccroll()`, `dccsim()`, `gogarchfit()`, `gogarchfilter()`, `gogarchforecast()`, `gogarchroll()`, `gogarchsim()`, … | \- |
| **[Rsolnp](https://cran.r-project.org/package=Rsolnp)** | `gosolnp()`, `startpars()` | \- |
