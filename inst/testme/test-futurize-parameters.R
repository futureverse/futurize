...
set.seed(42)
fit_lm <- bootstrap_model(model_lm, iterations = 10L) |> futurize()
print(head(fit_lm))
...
if (requireNamespace("lme4", quietly = TRUE)) {
  ...
  fit_lmer <- bootstrap_model(model_lmer, iterations = 10L) |> futurize()
...
set.seed(42)
params <- bootstrap_parameters(model_lm, iterations = 10L) |> futurize()
print(params)
